...
def odds():
    white_numbers = [
                     6.89, 7.57, 8.07, 6.76, 6.77, 7.42, 6.58, 6.13, 7.26, 7.12, 6.88, 7.13, 
                     4.82, 6.58, 6.98, 7.27, 6.85, 7.11, 7.96, 7.73, 8.69, 7.41, 8.13, 
                     7.56, 6.29, 6.09, 8.69, 8.08, 6.17, 6.75, 7.06, 8.39, 8.68, 5.67, 
                     6.71, 8.83, 7.86, 7.33, 8.12, 7.56, 6.67, 7.25, 6.05, 7.64, 7.27, 
                     5.77, 8.52, 6.32, 5.33, 7.05, 7.03, 6.66, 7.71, 7.39, 6.81, 7.43, 
                     6.59, 6.43, 8.22, 6.06, 9.26, 7.57, 8.45, 8.74, 6.12, 7.34, 7.78, 
                     7.77, 8.82
                     ]
    red_numbers = [
...
def predictions():
    white_numbers = [[27, 40, 44, 54, 56], 
                     [16, 19, 36, 51, 63], 
                     [3, 36, 49, 58, 60], 
                     [6, 12, 17, 50, 62], 
                     [23, 28, 29, 41, 52]
                     ]
    red_numbers = [18, 1, 11, 24, 12]
